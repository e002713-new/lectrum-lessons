...
const validation = (param1, param2) => {
    if (typeof param1 !== 'function') {
        throw new Error('first parameter is`t a function');
    } else if (typeof param2 !== 'object') {
        throw new Error('second parameter isn`t object');
    } else if (Array.isArray(param2)) {
        throw new Error('second parametr is array')
    }
};
